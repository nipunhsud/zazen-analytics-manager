...
@Configuration
@ComponentScan(basePackages="com.analyticsmanager")
@PropertySource( "classpath:application.properties")
@MapperScan("com.analyticsmanager.v1.dao")
@EnableWebMvc
public class AnalyticsManagerServiceConfiguration  extends WebMvcConfigurerAdapter {
	...
	public MultipartResolver multipartResolver(){
		...
		commonsMultipartResolver.setMaxUploadSize(5000000l);
